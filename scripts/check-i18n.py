...
PENDING_TRANSLATION: set[str] = {
    ...
    "Add_Kazumi_Progress",
    "Add_Kazumi_ExternalClient",
    "Add_Kazumi_ExternalClient_Hint",
    "Add_Kazumi_OpenedExternal",
    "Add_Kazumi_Err_ExternalClient",
    "Add_Kazumi_State_Metadata",
    "Add_Kazumi_State_Starting",
    "Add_Kazumi_State_Checking",
    "Add_Kazumi_State_Downloading",
    "Add_Kazumi_Complete",
    ...
    "CanIRunIt_Verdict_Inconclusive",
    "CanIRunIt_FallbackSummary",
    "CanIRunIt_FallbackComponent",
