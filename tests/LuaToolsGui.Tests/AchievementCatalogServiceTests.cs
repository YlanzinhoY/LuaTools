...
public class AchievementCatalogServiceTests
{
    ...
    {
        const string json = """
            {"appid":3751950,"achievement":"ACObsidian_Ach_10","changed":false,"account_id":1208830004,"stat_id":1,"bit":9,"permission":2,"timestamp":1787390253,"crc":3982734981,"host_status":"captured","cache_confirmed":true,"steam_refreshed":true,"steam_confirmed":true,"native_notification":"store_queued","stats_path":"C:\\steam\\appcache\\stats\\UserGameStats.bin","backup_path":null}
            """;
        ...
        Assert.True(result.CacheConfirmed);
